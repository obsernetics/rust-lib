...
* `bill` — قبض / pay-slip: bill-id and pay-id checksums + bill-type detection
  (water / electricity / gas / phone / mobile / municipality / tax / fines).
...
* Language detection — `is_persian`, `contains_persian`, `script::has_arabic`,
  `script::has_persian`, `script::is_pure_persian`, `script::to_arabic`.
